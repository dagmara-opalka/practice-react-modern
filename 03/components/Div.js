    ...
    return (
        <div style={{ border: `1px solid ${borderColor}` }}>
            ...
            <p>
                ...
                vitae porttitor purus, eget luctus nisi. Mauris ex nibh, aliquet venenatis sagittis
                vitae, lobortis vitae ex. Donec congue dui leo, at auctor est laoreet gravida.
            </p>
        </div>
    );
}
